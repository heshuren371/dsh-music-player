...
`;
    ...
    function MusicView() {
      ...
      const header = h("div", { className: "dshm-header" },
        ...
        state.tracks.length > 0 && h("span", { className: "dshm-stats" }, t("stats")(filteredTracks.length === state.tracks.length ? state.tracks.length : filteredTracks.length + "/" + state.tracks.length)),
        h("button", {
          type: "button",
          className: "dshm-btn",
      ...
      if (state.dir === null) {
        ...
        body = h("div", { className: "dshm-tableWrap" },
          h("table", { className: "dshm-table" },
            ...
            h("tbody", null, filteredTracks.map(({ track, index }) => h("tr", {
