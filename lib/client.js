...
`;
    ...
    function createPlayer() {
      ...
      const applyLibrary = (payload) => {
        ...
        set({
          dir: payload.dir,
          tracks: keepRows ? state.tracks : incoming,
      ...
      const updateMediaSession = () => {
        ...
        try {
          ...
          if (track !== undefined) probeCover(track);
          ...
          const artwork = track === undefined
            ? []
            : coverKnown.get(track.id) === false && fallback !== null
      ...
      return h("div", { className: "dshm-tableWrap" },
        h("table", { className: "dshm-table" },
          ...
          h("tbody", null, rows.map(({ track, index }) => h("tr", {
            ...
            h("td", { className: "dshm-cellArtist" }, track.artist ?? ""),
      ...
      const bar = h("div", { className: "dshm-bar" },
        h("div", { className: "dshm-nowPlaying" },
          ...
          h("div", { className: "dshm-nowText" },
            ...
            h("div", { className: "dshm-nowArtist" }, currentTrack?.artist ?? ""),
          ),
        ),
